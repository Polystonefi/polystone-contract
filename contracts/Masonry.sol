...
contract ShareWrapper {
    ...
    function withdraw(uint256 amount) public virtual {
        uint256 masonRock = _balances[msg.sender];
        require(
            masonRock >= amount,
            "Masonry: withdraw request greater than staked amount"
        );
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = masonRock.sub(amount);
...
contract Masonry is ShareWrapper, ContractGuard, Operator {
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            polystone.safeTransfer(msg.sender, reward);
        ...
        onlyOperator
    {
        ...
        polystone.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(Rock), "Polyrock");
